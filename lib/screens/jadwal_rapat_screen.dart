              ...
              child: Column(
                children: [
                  TextFormField(
                    ...
                    validator: (value) =>
                        value!.isEmpty ? 'Nama rapat tidak boleh kosong' : null,
                  ),
                ...
                builder: (ctx, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (ctx, index) {
                      final jadwal =
                          jadwalList[index].data() as Map<String, dynamic>;
                      // Mengambil data dari Firestore dan menangani field tidak ada
                      String namaRapat =
                          jadwal['nama_rapat'] ?? 'Nama Rapat Tidak Tersedia';
                      String waktuMulai =
                          jadwal['waktu_mulai'] ?? 'Waktu Mulai Tidak Tersedia';
                      String waktuSelesai = jadwal['waktu_selesai'] ??
                          'Waktu Selesai Tidak Tersedia';
                      String tanggalRapat =
                          jadwal['tanggal_rapat'] ?? 'Tanggal Tidak Tersedia';
